...
## How to use
  ...
  You can give a parameter 'cmp' into `__init__`. t must be a function or lambda expression with two parameter. It will be the compare method of the queue. In the queue, x < y only if cmp(x, y) is true.
